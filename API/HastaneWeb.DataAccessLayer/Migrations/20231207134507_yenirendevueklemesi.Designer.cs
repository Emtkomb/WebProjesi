...
namespace HastaneWeb.DataAccessLayer.Migrations
{
    ...
    [Migration("20231207134507_yenirendevueklemesi")]
    partial class yenirendevueklemesi
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HastaneWeb.EntityLayer.Concrete.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HastaneWeb.EntityLayer.Concrete.Randevu", b =>
                {
                    ...
                    b.Property<int>("DoktorNameDoktorID")
                        .HasColumnType("int");

                    b.Property<int>("HastaneAdiHastaneID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DoktorNameDoktorID");

                    b.HasIndex("HastaneAdiHastaneID");
            ...
            modelBuilder.Entity("HastaneWeb.EntityLayer.Concrete.Randevu", b =>
                {
                    b.HasOne("HastaneWeb.EntityLayer.Concrete.Doktor", "DoktorName")
                        .WithMany()
                        .HasForeignKey("DoktorNameDoktorID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HastaneWeb.EntityLayer.Concrete.Hastane", "HastaneAdi")
                        .WithMany()
                        .HasForeignKey("HastaneAdiHastaneID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DoktorName");

                    b.Navigation("HastaneAdi");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("HastaneWeb.EntityLayer.Concrete.AppUser", null)
                        .WithMany()
